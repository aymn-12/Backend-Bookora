...
// Only trust specific address types to prevent IP spoofing via X-Forwarded-For
...
app.use(cors({
    ...
    allowedHeaders: ['Content-Type', 'Authorization', 'X-CSRF-Token', 'Range', 'Cache-Control', 'Pragma'],
